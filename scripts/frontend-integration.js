 ...
 * This file demonstrates how to integrate Shiftgaze with a web frontend
 */

// For React/Vue/Angular applications
export class ShiftgazeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ShiftgazeClient(provider, contractAddress);
